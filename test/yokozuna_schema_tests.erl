...
basic_schema_test() ->
    ...
    cuttlefish_unit:assert_config(Config, "yokozuna.solr_request_timeout",
                                  60000),
    cuttlefish_unit:assert_config(Config, "yokozuna.solr_request_ed_timeout",
                                  60000),
    cuttlefish_unit:assert_config(Config, "yokozuna.anti_entropy", {on, []}),
    cuttlefish_unit:assert_config(Config, "yokozuna.err_thresh_fail_cnt",
                                  3),
    ...
    cuttlefish_unit:assert_config(Config, "yokozuna.solrq_worker_cnt", 10),
...
override_schema_test() ->
    ...
    cuttlefish_unit:assert_config(Config, "yokozuna.solrq_worker_cnt", 5),
    cuttlefish_unit:assert_config(Config, "yokozuna.solrq_helper_cnt", 20),
