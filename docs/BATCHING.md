...
![YZ Batching Overview](https://github.com/basho/yokozuna/docs/yz-batching-overview.png)
...
![YZ Batching Worker](https://github.com/basho/yokozuna/docs/yz-batching-worker.png)
